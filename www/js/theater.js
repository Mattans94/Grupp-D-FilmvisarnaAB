...
// 	start(){
// 		this.eventHandler();
// 		// this.theaterObjectType(this.auditorium);
// 		// this.getTheaterObject(this.theaterObjectType);
...
// 	renderTicketButtons() {
// 		let html ='';
// 		console.log('renderTicketButtons');
...
// 				    <input type="text" class="form-control" id="childTickets" placeholder="0" >
...
// 				    <input type="text" class="form-control" id="adultTickets" placeholder="0" >
...
// 				    <input type="text" class="form-control" id="pensionerTickets" placeholder="0" >
...
// 			let seat = $(this);
// 			let noOfSeatsToBook = numberOfChildren, numberOfAdults, numberOfPensioners;
// 			console.log('noOfSeatsToBook',noOfSeatsToBook);
